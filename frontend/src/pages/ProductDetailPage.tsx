...
import { ChevronRight, Tag, ShoppingCart, Truck, ArrowLeft } from 'lucide-react';
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <div className="mt-3">
              ...
              <p className="text-3xl text-gray-900 font-bold">{formatPrice(product.unit_price)}</p>
              <p className="text-sm text-gray-500 mt-1">Including tax: {product.price_with_tax}</p>
            </div>
            ...
            <div className="mt-6 border-t border-gray-200 pt-6">
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-sm text-gray-700">Fast shipping - 2-3 business days</p>
                </div>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <p className="text-sm text-gray-700">Premium quality materials</p>
                </div>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-8">
              <div className="flex sm:flex-col1">
                <div className="max-w-xs">
                  ...
                  <div className="flex border border-gray-300 rounded-md">
                    ...
                    <input
                      ...
                      className="block w-16 text-center border-0 focus:ring-0"
                    />
                    <button
                      type="button"
                ...
                <Button
                  variant="primary"
                  className="ml-4 sm:ml-0 sm:mt-4"
